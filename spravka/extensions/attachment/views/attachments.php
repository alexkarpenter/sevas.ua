...
<? if (!isset($this->getController()->clips['attachments_templ'])): ?>
<? $this->getController()->beginClip('attachments_templ') ?>
<script id="attachments_templ" type="text/javascript-templ">
...
<? echo $this->getController()->clips['attachments_templ']; ?>
<? endif; ?>
