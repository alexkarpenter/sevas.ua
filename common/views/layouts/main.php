              ...
              <!-- footer -->
                                    ...
                                    <div class="popup-holder" id="login-popup-wrap" style="display:none;">
                                                ...
                                                <form method="post" id="login-form" name="login" class="tab">
                                                    <fieldset>
                                                        ...
                                                        <input type="hidden" name="do" value="aut">
                                                            <div class="row">
                                                                <label class="input-wrap"><input type="text" name="username" value="Логин" onblur="if (this.value == '') {
                                        this.value = 'Логин';
                                        ...
                                        this.value = '';
                                                            ...
                                                            <div class="row">
                                                                <label class="input-wrap"><input type="text" name="password" value="Пароль" onblur="if (this.value == '') {
                                        this.type = 'text';
                                        this.value = 'Пароль';
                                        ...
                                        this.value = '';
                                                ...
                                                <form method="post" id="registration-form" name="registration" class="tab" style="display:none;">
                                                    <fieldset>
                                                        ...
                                                        <div class="row">
                                                            <label class="input-wrap"><input type="text" name="username" value="Желаемый логин" onblur="if (this.value == '') {
                                        ...
                                        this.value = '';
                                                        ...
                                                        <div class="row">
                                                            <label class="input-wrap"><input type="text" name="email" value="Email" onblur="if (this.value == '') {
                                        this.value = 'Email';
                                        ...
                                        this.value = '';
                                                        ...
                                                        <div class="row">
                                                            <label class="input-wrap"><input type="text" name="password_confirm" value="Пароль еще раз" onblur="if (this.value == '') {
                                        this.type = 'text';
