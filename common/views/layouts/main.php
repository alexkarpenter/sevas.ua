...
<!--         
		<script type="text/javascript" src="/js/news_func.js"></script> 
...
-->
                ...
                <div class="top-panel">
                    ...
                    <div class="block">
						<?php if(!Yii::app()->user->isGuest) {
							echo "<div class='row'><div class='user_icon'></div><a id='head-user-menu-profile-login' href='/u/11505'>".Yii::app()->user->name."</a> | <a id='head-user-menu-profile-exit' href='/user/logout'>Выход</a></div>";
						}else{
							echo  "<div class='row'>
    ...
    <div class="popup-holder" id="login-popup-wrap" style="display:none;">
        ...
        <div class="login-popup" style="margin: 0px;">
            ...
            <div class="tab-body">
                <form method="post" id="login-form" action="/user/login" name="login" class="tab">
                    <fieldset>
                        ...
                        <input type="hidden" name="do" value="aut">
                            <div class="row">
                                <label class="input-wrap"><input type="text" id="LoginForm_username" name="LoginForm[username]" value="Логин" onblur="if (this.value == '') {
                                        this.value = 'Логин';
                                    }" onfocus="if (this.value == 'Логин') {
                                        this.value = '';
                                    }"></label>
                                <div class="error">Введите Email</div>
                            </div>
                            <div class="row">
                                <label class="input-wrap"><input type="text" id="LoginForm_password" name="LoginForm[password]" value="Пароль" onblur="if (this.value == '') {
                                        this.type = 'text';
                                        this.value = 'Пароль';
                            ...
                            <div class="row">
                                <span class="gray-btn">Вход <input type="submit" class="login-form-submit" value="Login" title="Вход"></span>
                            </div>
                ...
                <form method="post" id="reg-form" action="/user/reg" name="registration" class="tab" style="display:none;">
                    <fieldset>
                        <p>Для того чтобы зарегистрироваться на сайте, пожалуйста заполните все поля в форме ниже</p>
                        <div class="row">
                            <label class="input-wrap"><input type="text" id="RegForm_login" name="RegForm[login]" value="Желаемый логин" onblur="if (this.value == '') {
                                        this.value = 'Желаемый логин';
                                    }" onfocus="if (this.value == 'Желаемый логин') {
                                        this.value = '';
                                    }"></label>
                            <div class="error">Заполните поле</div>
                        </div>
                        <div class="row">
                            <label class="input-wrap"><input type="text" id="RegForm_email" name="RegForm[email]" value="Email" onblur="if (this.value == '') {
                                        this.value = 'Email';
                        ...
                        <div class="row">
                            <label class="input-wrap"><input type="text" id="RegForm_password" name="RegForm[password]" value="Пароль" onblur="if (this.value == '') {
                                        this.type = 'text';
                                        this.value = 'Пароль';
                                    }" onfocus="if (this.value == 'Пароль') {
                                        this.type = 'password';
                        ...
                        <div class="row">
                            <label class="input-wrap"><input type="text" id="RegForm_password_repeat" name="RegForm[password_repeat]" value="Пароль еще раз" onblur="if (this.value == '') {
                                        this.type = 'text';
                        ...
                        <div class="row">
                            <span class="gray-btn">Зарегистрировать <input type="submit" id="registration-data-submit-button" value="Регистрация" title="Зарегистрировать"></span>
