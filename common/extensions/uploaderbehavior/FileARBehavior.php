...
class FileARBehavior extends CActiveRecordBehavior {
	...
	public function getFolderPath() {
        if(strpos($this->relativeWebRootFolder,'.'))
            return Yii::getPathOfAlias($this->relativeWebRootFolder);
        else
	 ...
	 */
	public function saveFile($file, $filePath, $fileName, $ext) {
		$klass = null;
	 ...
	 */
	public function deleteFile($path, $fname) {
		$fs = $this->getAnyExistingFilesName($path, $fname);
